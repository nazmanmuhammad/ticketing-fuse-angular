                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <p style="margin: 0 0 25px 0; font-size: 15px; color: #4b5563; line-height: 1.6;">
                                Hello <strong style="color: #1f2937;">{{ $recipientName }}</strong>, A ticket has been successfully created. Please review and follow up according to the stated priority.
                            </p>
                                    ...
                                    <td style="background-color: #0E0F6B; color: #ffffff; padding: 12px 20px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="background-color: rgba(255,255,255,0.2); padding: 4px 12px; border-radius: 12px; font-size: 11px; font-weight: 600; display: inline-block;">OPEN</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
