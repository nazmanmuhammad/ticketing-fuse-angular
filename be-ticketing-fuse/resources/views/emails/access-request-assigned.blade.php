                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background-color: #0E0F6B; padding: 30px; text-align: center;">
                            <img src="{{ $logoUrl }}" alt="{{ $appSettings->app_name ?? 'WorkDesk' }}" style="height: 40px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <h1 style="color: #333333; font-size: 24px; margin: 0 0 20px 0;">Access Request Assigned to You</h1>
                            
                            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 0 0 20px 0;">
                                Hello <strong>{{ $accessRequest->picTechnical->name ?? 'Technical Support' }}</strong>,
                            </p>
                            
                            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 0 0 30px 0;">
                                A new access request has been assigned to you. Please review and process it accordingly.
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e0e0e0;">
                            <img src="{{ $sigLogoUrl }}" alt="SIG" style="height: 60px; margin-bottom: 15px;">
